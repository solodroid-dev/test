...
public class Constant {
    ...
    public static String AD_NETWORK = "huawei";
    ...
    public static final String PANGLE_APP_ID = "8025677";
    public static final String PANGLE_BANNER_ID = "980099802";
    public static final String PANGLE_INTERSTITIAL_ID = "980088188";
    public static final String PANGLE_REWARDED_ID = "980088192";
    public static final String PANGLE_NATIVE_ID = "980088216";
    public static final String PANGLE_APP_OPEN_AD_ID = "890000078";
    ...
    public static final String HUAWEI_NATIVE_ID = "testu7m3hc4gvm";
