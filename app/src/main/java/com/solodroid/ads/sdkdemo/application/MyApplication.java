...
import com.solodroid.ads.sdk.format.AppOpenAdPangle;
...
public class MyApplication extends Application {
    ...
    private AppOpenAdPangle appOpenAdPangle;
    ...
    public void onCreate() {
        ...
        if (!Constant.FORCE_TO_SHOW_APP_OPEN_AD_ON_START) {
            ...
            appOpenAdPangle = new AppOpenAdPangle();
        }
    }
                    ...
                    if (Constant.AD_STATUS.equals(AD_STATUS_ON)) {
                        switch (Constant.AD_NETWORK) {
                            ...
                            case WORTISE:
                                ...
                                break;
                            case PANGLE:
                                if (!Constant.PANGLE_APP_OPEN_AD_ID.equals("0")) {
                                    if (!currentActivity.getIntent().hasExtra("unique_id")) {
                                        appOpenAdPangle.showAdIfAvailable(currentActivity, Constant.PANGLE_APP_OPEN_AD_ID);
                                    }
                                }
                                break;
                        }
        ...
        if (Constant.OPEN_ADS_ON_START) {
            if (Constant.AD_STATUS.equals(AD_STATUS_ON)) {
                switch (Constant.AD_NETWORK) {
                    ...
                    case PANGLE:
                        if (!Constant.PANGLE_APP_OPEN_AD_ID.equals("0")) {
                            appOpenAdPangle.showAdIfAvailable(activity, Constant.PANGLE_APP_OPEN_AD_ID, onShowAdCompleteListener);
                            Constant.isAppOpen = true;
                        }
                        break;
                }
