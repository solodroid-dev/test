...
import com.solodroid.ads.sdk.listener.OnRewardedAdCompleteListener;
import com.solodroid.ads.sdk.listener.OnRewardedAdDismissedListener;
import com.solodroid.ads.sdk.listener.OnRewardedAdErrorListener;
...
public class RewardedAd {
    ...
    public static class Builder {
        ...
        public Builder setHuaweiRewardedId(String huaweiRewardedId) {
                ...
                switch (mainAds) {
                    ...
                    case HUAWEI:
                        if (huaweiRewardedAd == null) {
                            ...
                            builder.addBiddingParamMap(huaweiRewardedId, biddingParam);
                            builder.setTMax(500);
